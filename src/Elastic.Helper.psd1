...
FunctionsToExport = 'Deploy-EsConfig', 'Get-EsEnrichmentPolicy', 'Get-EsHelperConfig',
               'Get-EsIndex', 'Get-EsIndexSettings', 'Get-EsPipeline',
               ...
               'Invoke-EsBulkIndexRequest', 'Get-EsIndexDefinition',
               'ConvertTo-EsBulkIndex'
